...
function ClassCard({ classObj = {}, onSave, onCancel, onDelete }) {
    ...
    return (
        <div className={classnames('w-full max-w-4xl p-6 bg-white rounded-lg shadow mb-4', {
            ...
            <form className="flex flex-wrap items-center gap-4">
                <div className="flex-1 min-w-0">
                    <label htmlFor="crn" className="block mb-2 text-sm font-medium text-gray-900">CRN</label>
                    <input
                        type="number"
                        name="crn"
                        id="crn"
                ...
                <div className="flex-1 min-w-0">
                    <label htmlFor="isOpen" className="block mb-2 text-sm font-medium text-gray-900">Is Open</label>
                    <input
                        type="checkbox"
                        name="isOpen"
                        id="isOpen"
                        checked={classData.isOpen}
                        onChange={() => setClassData({ ...classData, isOpen: !classData.isOpen })}
                        className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    />
                </div>
